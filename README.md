...
2. [About the Project](#About-the-Project)
   a.Explore the [Deployed Password Generator](https://suzylebel.github.io/Password-Generator/)
   b.View the [Github page](https://github.com/suzylebel/Password-Generator)
